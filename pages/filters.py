    ...
    def cycle_check_boots(self):
        ...
        for i in range(len(response_type_filter['colors'])):
            ...
            for i in range(len(request_color['items'][0]['cells'])):
                ...
                page.assert_check_expressions(filter_color_name_product_json, filter_color_name_product, ' имя товара не соответствует цвету' + filter_color_name_product_json + filter_color_name_product)
